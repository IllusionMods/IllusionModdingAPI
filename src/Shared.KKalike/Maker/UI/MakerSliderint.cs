...
namespace KKAPI.Maker.UI
{
    ...
    /// </summary>
    public class MakerIntSlider : BaseEditableGuiEntry<float>
    {
        ...
        public MakerIntSlider(MakerCategory category, string settingName, float minValue, float maxValue, float defaultValue, BaseUnityPlugin owner, bool Wholenumbers = false) : base(category, defaultValue, owner)
        {
