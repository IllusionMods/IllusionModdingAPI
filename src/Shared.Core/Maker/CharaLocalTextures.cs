...
namespace KKAPI.Maker {
    ...
    public static partial class CharaLocalTextures
    {
        ...
        internal static ConfigEntry<bool> AlwaysUseFallbackLocalTexUI { get; set; }
        ...
        static CharaLocalTextures()
        {
            ...
            string description = "Whether external textures used by plugins should be bundled with the card (Standard), or saved to a configurable local folder (Local).\nWARNING: Cards with local textures save storage space but cannot be shared.";
