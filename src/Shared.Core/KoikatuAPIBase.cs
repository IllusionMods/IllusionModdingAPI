...
namespace KKAPI
{
    ...
    public partial class KoikatuAPI
    {
        ...
        /// </summary>
        public const string VersionConst = Constants.Version;
        ...
        internal static ConfigEntry<string> RememberFilePickerSaveLoadState { get; set; }
        ...
        private void BaseAwake()
        {
            ...
            RememberFilePickerSaveLoadState = Config.Bind("General", "Saved paths", string.Empty);
