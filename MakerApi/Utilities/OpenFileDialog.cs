...
namespace MakerAPI.Utilities
{
    ...
    public class OpenFileDialog
    {
        ...
        /// WARNING: This runs on another thread! Game will crash if you attempt to access unity methods, you have to save the results and handle them in Update etc.</param>
        /// <param name="title">
        /// A string to be placed in the title bar of the dialog box. If this member is NULL, the system uses
        /// the default title (that is, Save As or Open)
        /// </param>
